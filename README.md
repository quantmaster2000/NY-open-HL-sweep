Download all the py files. Put it in a folder. Put the TimeAggregated and TickAggregated folder (download it from the link in dc) inside the same folder.


It should look like this:
<img width="632" height="403" alt="image" src="https://github.com/user-attachments/assets/d29d10f9-cff4-43e8-bfcb-c1efabb838ce" />
